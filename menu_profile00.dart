...
class MenuProfile00 extends StatelessWidget {
  const MenuProfile00({super.key});
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: const Center(child: Text("MENU PROFILE-00")),
          actions: [
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        ...
        children: [
          Center(child: Text("MENU PROFILE-00")),
          Text(username_pref_),
          Text(name_pref_),
        ],
      ),
